...
export default function EggLoader() {
  ...
  return (
    <Box position='relative' mx='auto' w='62px' h='82px'>
      ...
      <Box position='absolute' top={0} left={0} as='svg' width="64px" height="74px" viewBox="0 0 64 74" fill="none" xmlns="http://www.w3.org/2000/svg">
