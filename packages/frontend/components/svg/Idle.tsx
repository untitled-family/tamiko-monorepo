...
export default function Idle() {
  return (
    <Box as='svg' mx='auto' width="62px" viewBox="0 0 19 27" fill="none" xmlns="http://www.w3.org/2000/svg">
      <g id="tamiko-sleep">
        ...
        <path id="base-shade" d="M5 13H4V14H3V15H2V24H4V23H3V15H4V14H5V13Z" fill="#5C5E6D" />
        <path id="face" fill-rule="evenodd" clip-rule="evenodd" d="M15 14V15H16V23H7V22H6V20H5V17H6V15H7V14H15ZM9 22V21H11V22H9ZM12 22V21H14V22H12Z" fill="white" />
        <g id="outline-and-eyes">
          <path d="M11 20H9V21H11V20Z" fill="#14181F" />
          <path d="M12 20H14V21H12V20Z" fill="#14181F" />
          <path fill-rule="evenodd" clip-rule="evenodd" d="M4 12V13H3V14H2V15H1V24H2V25H16V24H17V15H16V14H15V13H14V12H4ZM14 13V14H15V15H16V24H2V15H3V14H4V13H14Z" fill="#14181F" />
        </g>
